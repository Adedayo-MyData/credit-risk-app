...
def preprocess_input(data):
    ...
    data['income_per_year_of_emp'] = data['person_income'] / (df['person_emp_length'] + 1)
    data['interest_income_ratio'] = data['loan_int_rate'] / (df['person_income'] + 1)
    data['credit_exp_ratio'] = data['cb_person_cred_hist_length'] / df['person_age']
